...
contract UsagePoints is Ownable, Pausable, IUsageHook {
    ...
    event PointsAdded(address indexed user, uint256 indexed epoch, uint256 added, uint256 newUserPoints, uint256 newTotalPoints, bytes32 ref);
    event Paused();
    event Unpaused();
